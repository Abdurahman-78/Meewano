...
interface Props { hostFirstName?: string; bookingShortId?: string }

const BRAND = '#FF5780'; const INK = '#1a1a1a'; const MUTED = '#6b7280'

const Email = ({ hostFirstName, bookingShortId }: Props) => (
  <Html lang="en"><Head />
    <Preview>Refund approval confirmed</Preview>
    <Body style={main}><Container style={container}>
      <Section style={header}><Text style={brand}>Meewano</Text></Section>
      <Section style={card}>
        <Heading style={h1}>Refund approval confirmed</Heading>
        <Text style={text}>Hi {hostFirstName || 'there'},</Text>
        <Text style={text}>
          Thank you for approving the refund request for booking number <strong>#{bookingShortId}</strong>.
...
export const template = {
  component: Email,
  subject: 'Refund approval confirmed',
  displayName: 'Refund approved — host',
  previewData: { hostFirstName: 'Ali', bookingShortId: 'A1B2C3' },
