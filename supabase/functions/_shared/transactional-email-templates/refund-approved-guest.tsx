...
interface Props { firstName?: string; bookingShortId?: string; refundAmount?: string }

const BRAND = '#FF5780'; const INK = '#1a1a1a'; const MUTED = '#6b7280'

const Email = ({ firstName, bookingShortId, refundAmount }: Props) => (
  <Html lang="en"><Head />
    <Preview>Your refund request has been approved</Preview>
    <Body style={main}><Container style={container}>
      ...
      <Section style={card}>
        ...
        <Text style={text}>
          Your refund request of <strong>{refundAmount}</strong> for booking number <strong>#{bookingShortId}</strong> has been approved by the host.
...
export const template = {
  ...
  displayName: 'Refund approved — guest',
  previewData: { firstName: 'Karwan', bookingShortId: 'A1B2C3', refundAmount: '250,000 IQD' },
